    ...
    <div id="login-pemilik" class="login">
        <div class="container">
            ...
            <div class="login-container border-secondary box-shadow">
                ...
                ?>
                <form action='../login/pemilik' method="post" autocomplete="off">
                    ...
                    <button id="btn-submit"type="submit" value="pemilik" name="login" class="btn btn-secondary " disabled>Masuk</button>
                </form>
            </div>
        </div>
    </div>
